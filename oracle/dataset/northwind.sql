-- Northwind dataset for Oracle Database (Free 23ai).
-- Adapted from the PostgreSQL Northwind dump.
--
-- Init scripts in gvenzl/oracle-free run as SYS against the CDB, so we
-- reconnect into the FREEPDB1 application schema before creating objects.
...
CREATE TABLE customer_customer_demo (
    ...
    customer_type_id VARCHAR2(5) NOT NULL
);

CREATE TABLE customer_demographics (
    customer_type_id VARCHAR2(5) NOT NULL,
    customer_desc VARCHAR2(4000)
);
...
CREATE TABLE region (
    ...
    region_description VARCHAR2(60) NOT NULL
);
...
CREATE TABLE territories (
    territory_id VARCHAR2(20) NOT NULL,
    territory_description VARCHAR2(60) NOT NULL,
    region_id NUMBER(5) NOT NULL
);

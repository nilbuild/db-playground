--
-- Northwind dataset for DuckDB
-- Converted from the Postgres dump in ../postgres/dataset/northwind.sql
--
...
--
-- Primary keys (as unique indexes; SQLite cannot ADD CONSTRAINT via ALTER)
--

CREATE UNIQUE INDEX pk_categories ON categories (category_id);
CREATE UNIQUE INDEX pk_customer_customer_demo ON customer_customer_demo (customer_id, customer_type_id);
CREATE UNIQUE INDEX pk_customer_demographics ON customer_demographics (customer_type_id);
CREATE UNIQUE INDEX pk_customers ON customers (customer_id);
CREATE UNIQUE INDEX pk_employees ON employees (employee_id);
CREATE UNIQUE INDEX pk_employee_territories ON employee_territories (employee_id, territory_id);
...
CREATE UNIQUE INDEX pk_region ON region (region_id);
CREATE UNIQUE INDEX pk_shippers ON shippers (shipper_id);
CREATE UNIQUE INDEX pk_suppliers ON suppliers (supplier_id);
CREATE UNIQUE INDEX pk_territories ON territories (territory_id);
CREATE UNIQUE INDEX pk_usstates ON us_states (state_id);
